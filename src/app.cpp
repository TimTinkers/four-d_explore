...
/* Create a renderpass instance */
  ...
  gfx_manager_ptr->set_input_assembly_properties(
      pipeline_id_, VK_PRIMITIVE_TOPOLOGY_LINE_STRIP);
...
void App::init_command_buffers() {
  ...
  for (unsigned int n_current_swapchain_image = 0;
    ...
    Anvil::BufferBarrier t_value_buffer_barrier = Anvil::BufferBarrier(
        ...
        VK_QUEUE_FAMILY_IGNORED, VK_QUEUE_FAMILY_IGNORED, timeUniformPointer,
        n_current_swapchain_image * timeUniformSizePerSwapchain, sizeof(float));
        ...
        renderpass_ptr_, VK_SUBPASS_CONTENTS_INLINE);
    {
      ...
      draw_cmd_buffer_ptr->record_draw(11, 1, /* instanceCount */
                                       0,     /* firstVertex   */
                                       0);    /* firstInstance */
    }
