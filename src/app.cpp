...
void App::init_buffers() {
	...
	for (uint32_t vertexIndex = 0; vertexIndex < 11; ++vertexIndex) {
	...
	std::vector<glm::vec4> vertexData = { 
		glm::vec4(0, 0, 1, 1), glm::vec4(0, 0.5, 1, 1), glm::vec4(0.5, 0.5, 1, 1), glm::vec4(0.5, 0, 1, 1),
		glm::vec4(0, 0, 1, 1), glm::vec4(0.25, -0.25, 1, 1), glm::vec4(0.75, -0.25, 1, 1), glm::vec4(0.75, .25, 1, 1),
                glm::vec4(0.5, 0.5, 1, 1), glm::vec4(0.5, 0, 1, 1), glm::vec4(0.75, -0.25, 1, 1)
	};
	...
	*/
	...
	for (unsigned int vertexIndex = 0; vertexIndex < 11; ++vertexIndex) {
...
void App::init_command_buffers() {
	...
	for (unsigned int n_current_swapchain_image = 0;
			...
			VK_SUBPASS_CONTENTS_INLINE);
		{
			...
			draw_cmd_buffer_ptr->record_draw(11,
				1,                /* instanceCount */
				0,                /* firstVertex   */
				0); /* firstInstance */
		}
